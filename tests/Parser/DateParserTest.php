...
class DateParserTest extends \PHPUnit\Framework\TestCase
{
    public function testParseDate()
    {
        ...
        $this->assertEquals($parser->getCurrentDateTime()->format('Y-m-d H:i:s'), $parser->getDateTime('############# EST')->format('Y-m-d H:i:s'));
        $this->assertEquals($parser->getCurrentDateTime()->format('Y-m-d H:i:s'), $parser->getDateTime('Wed, 30 Nov -0001 00:00:00 +0000')->format('Y-m-d H:i:s'));
        $this->assertEquals($parser->getCurrentDateTime()->format('Y-m-d H:i:s'), $parser->getDateTime('čet, 24 maj 2012 00:00:00')->format('Y-m-d H:i:s'));
        $this->assertEquals($parser->getCurrentDateTime()->format('Y-m-d H:i:s'), $parser->getDateTime('-0-0T::Z')->format('Y-m-d H:i:s'));
        $this->assertEquals($parser->getCurrentDateTime()->format('Y-m-d H:i:s'), $parser->getDateTime('Wed, 18 2012')->format('Y-m-d H:i:s'));
        $this->assertEquals($parser->getCurrentDateTime()->format('Y-m-d H:i:s'), $parser->getDateTime("'2009-09-30 CDT16:09:54")->format('Y-m-d H:i:s'));
        $this->assertEquals($parser->getCurrentDateTime()->format('Y-m-d H:i:s'), $parser->getDateTime('ary 8 Jan 2013 00:00:00 GMT')->format('Y-m-d H:i:s'));
        $this->assertEquals($parser->getCurrentDateTime()->format('Y-m-d H:i:s'), $parser->getDateTime('Sat, 11 00:00:01 GMT')->format('Y-m-d H:i:s'));
